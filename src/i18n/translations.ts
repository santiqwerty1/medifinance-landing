...
export const translations = {
  es: {
    ...
    hero: {
      ...
      subtitle: 'Controla tus pacientes, sesiones e ingresos desde web y móvil. Gratis para siempre hasta 10 pacientes.',
      cta: 'Comenzar Gratis',
      ctaSecondary: 'Ver Demo',
      badge: 'Gratis para siempre • Sin tarjeta de crédito',
      noCreditCard: 'Sin tarjeta de crédito',
      patientsFree: '10 pacientes gratis',
    ...
    pricing: {
      ...
      plans: {
        ...
        pro: {
          name: 'Pro',
          period: '/mes',
          priceNote: 'Desde $4.99/mes • Anual: desde $49.99/año',
        ...
        business: {
          name: 'Business',
          period: '/mes',
          priceNote: 'Desde $11.99/mes • Anual: desde $119.99/año',
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'El plan Free es gratis para siempre (hasta 10 pacientes). Pro cuesta desde $4.99/mes ($49.99/año) y Business desde $11.99/mes ($119.99/año), dependiendo de tu país. Usamos precios justos adaptados al poder adquisitivo de cada región (PPP). Argentina paga en pesos argentinos, no en dólares.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Sí, puedes actualizar o bajar de plan cuando quieras. Si bajas de Pro a Free y tienes más de 10 pacientes, seguirás viendo todos tus datos pero no podrás agregar más pacientes hasta que estés por debajo del límite.',
        },
        {
        ...
        {
          question: '¿Qué incluye el plan Business que se lanza en Q2 2026?',
          answer: 'El plan Business está diseñado para equipos y consultorios con múltiples profesionales. Incluirá cuentas multi-usuario (hasta 5 usuarios), analíticas avanzadas, agenda de citas, links de pago con MercadoPago, reportes sin marca, soporte prioritario en 4 horas y acceso a API. Los usuarios actuales tendrán acceso anticipado.',
        },
      ],
    },
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: 'Manage your patients, sessions, and income from web and mobile. Free forever for up to 10 patients.',
      cta: 'Start Free',
      ctaSecondary: 'View Demo',
      badge: 'Free forever • No credit card required',
      noCreditCard: 'No credit card',
      patientsFree: '10 patients free',
    ...
    pricing: {
      ...
      plans: {
        ...
        pro: {
          name: 'Pro',
          period: '/month',
          priceNote: 'Starting at $4.99/month • Annual: from $49.99/year',
        ...
        business: {
          name: 'Business',
          period: '/month',
          priceNote: 'Starting at $11.99/month • Annual: from $119.99/year',
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: 'The Free plan is free forever (up to 10 patients). Pro costs from $4.99/month ($49.99/year) and Business from $11.99/month ($119.99/year), depending on your country. We use fair pricing adapted to each region\'s purchasing power (PPP). Argentina pays in Argentine pesos, not dollars.',
        },
        {
        ...
        },
        {
          ...
          answer: 'Yes, you can upgrade or downgrade anytime. If you downgrade from Pro to Free and have more than 10 patients, you\'ll still see all your data but can\'t add more patients until you\'re below the limit.',
        },
        {
        ...
        {
          question: 'What does the Business plan launching Q2 2026 include?',
          answer: 'The Business plan is designed for teams and clinics with multiple professionals. It will include multi-user accounts (up to 5 users), advanced analytics, appointment scheduling, MercadoPago payment links, white-label reports, priority support in 4 hours, and API access. Current users will have early access.',
        },
      ],
    },
